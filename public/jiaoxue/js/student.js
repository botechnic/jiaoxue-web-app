...
function resize_vol() {
    ...
    volume_bar_1.style.width = volume_bar_bg.clientWidth * playback_volume + 'px';
...
var interval_function = function () {
    var current_time = Number(document.getElementById("video1").currentTime).toFixed(1);
    var duration = Number(document.getElementById("video1").duration).toFixed(1);
    var whiteboard_container = document.getElementById('whiteboard_container');
    document.getElementById("curr_pos").innerHTML = get_time_str(current_time);
    document.getElementById("seek_bar_2").style.left =current_time/duration* (whiteboard_container.clientWidth ) + 'px';
...
if(global_info.biz_type === 'playback' ||
    ...
    function send_seek(e) {
        ...
        var bili = curr_x / document.getElementById('whiteboard_container').clientWidth;
        var pos = (total * bili).toFixed(0);
        console.log('pos', pos);
        socket.emit('seek_playback', { pos: pos*1000 });
        document.getElementById("curr_pos").innerHTML = get_time_str(Number(pos));
        document.getElementById("video1").currentTime = pos;
    }

    document.getElementById('seek_bar_bg').addEventListener('mousedown', seek_bar_mouse_down);
    document.getElementById('seek_bar_bg').addEventListener('mouseup', seek_bar_mouse_up);
    document.getElementById('seek_bar_1').addEventListener('mousedown', seek_bar_mouse_down);
    document.getElementById('seek_bar_1').addEventListener('mouseup', seek_bar_mouse_up);
    ...
    document.getElementById('volume_bar_bg').addEventListener('mousedown', volume_bar_mouse_down);
    document.getElementById('volume_bar_bg').addEventListener('mouseup', volume_bar_mouse_up);
    document.getElementById('volume_bar_1').addEventListener('mousedown', volume_bar_mouse_down);
    document.getElementById('volume_bar_1').addEventListener('mouseup', volume_bar_mouse_up);
}
///////////////////////////////////////////////////////////////////////////////
// record part
// 
