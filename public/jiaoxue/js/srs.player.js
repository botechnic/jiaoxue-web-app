...
function SrsPlayer(container, width, height, private_object) {
    ...
    this.buffer_time = 0.1; // default to 0.8
    this.volume = 0.8; // default to 100%
...
SrsPlayer.prototype.start = function(url) {
    ...
    swfobject.embedSWF(
        "./asset/srs_player.swf?_version="+srs_get_version_code(), 
        this.container,
        this.width, this.height,
        "11.1.0", "./asset/AdobeFlashPlayerInstall.swf",
